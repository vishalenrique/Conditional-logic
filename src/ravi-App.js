...
//   console.log("fieldChangeEffects",fieldChangeEffects);
...
//     );
//     //console.log( "Check with the value below ",fieldsState);
//     //console.log( "Check with he value above ",{ [i]: event.target.value });
//     //console.log("test2");
